...
Found by a reader comparing cinemas in Helsinki, recorded in `FLOW_REVIEW.md`.
...
recorded in `FLOW_REVIEW.md`; the CTA beside it had carried `area` and `lang` since it was
...
language appeared to change what was on. Recorded live in `FLOW_REVIEW.md`.
