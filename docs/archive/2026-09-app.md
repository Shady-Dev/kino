...
**36 px to the eye, 44 px of hit area**, through the transparent extension `.chip` and
`.seg` already use, carried by a wrapper because a select cannot hold a pseudo-element.
