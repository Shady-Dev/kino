...
@media(max-width:560px){.wrap{padding:0 14px 28px}.logo{font-size:.82rem;letter-spacing:.08em}h1{font-size:1.3rem}.film{display:grid;grid-template-columns:auto minmax(0,1fr);gap:0 18px}.info{display:contents}.poster{grid-column:1;grid-row:1/-2;width:72px;height:104px}.info>*{grid-column:2}.times{grid-column:1/-1}h3{font-size:1.02rem}.syn{display:-webkit-box;-webkit-box-orient:vertical;-webkit-line-clamp:3;line-clamp:3;overflow:hidden}}
